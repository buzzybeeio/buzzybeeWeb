...
export default () => (
  <div style={{ color: '#222', backgroundColor: 'lightgrey', padding: '30px 0' }}>
    <div className="container">
      <h3>Built by Software Engineers for Software Engineers</h3>
      <div className="indented" style={{ fontWeight: 300 }}>
        <p>
        ...
        feature feel free to submit a PR to our <a href="https://github.com/buzzybeeio" target="_blank" rel="noopener noreferrer">GitHub</a>.
        </p>
      </div>
    </div>
  </div>
